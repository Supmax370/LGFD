...
from utils.attentions import se_block, cbam_block, eca_block, CA_Block, FSA_block

attention_bocks = [se_block, cbam_block, eca_block, CA_Block, FSA_block]
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False, phi_attention=0, pruned=1):
        ...
        if phi_attention >= 1 and phi_attention <= 5:
