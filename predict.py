...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    mode = "heatmap"#visual_featuremap
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        img = "/data/user7/wt/datasets/FLIR-Aligned/VOCdevkit/VOC2007/JPEGImages/FLIR_04260.jpg"
        caption = "AAAA"
        image = Image.open(img)
        yolo.detect_heatmap(image,caption, heatmap_save_path)

    elif mode == "visual_featuremap":
        img = "/data/user7/wt/datasets/FLIR-Aligned/VOCdevkit/VOC2007/JPEGImages/FLIR_04260.jpg"
        caption = "AAAA"
        image = Image.open(img)
        yolo.visual_featuremap(image, caption, heatmap_save_path)
